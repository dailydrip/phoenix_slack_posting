defmodule SlackPosting.RobotTest do
  ...
  test "creates messages if tagged in a thread" do
    ...
    # Doesn't comment since there was nothing but a tag for the original message
    assert 0 == length(Journals.list_comments())
  end

  test "replies to messages with comments" do
    message =
      create_message("josh", "foo")
    ...
    reply =
      create_reply(message, "franzejr", "I agree $js")
    ...
    assert 1 == length(Journals.list_comments())
  end
