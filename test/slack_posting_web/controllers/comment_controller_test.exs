defmodule SlackPostingWeb.CommentControllerTest do
  use SlackPostingWeb.ConnCase

  alias SlackPosting.Journals
  alias SlackPosting.Journals.Comment

  @create_attrs %{slack_id: "some slack_id", text: "some text"}
  @update_attrs %{slack_id: "some updated slack_id", text: "some updated text"}
  @invalid_attrs %{slack_id: nil, text: nil}

  def fixture(:comment) do
    {:ok, comment} = Journals.create_comment(@create_attrs)
    comment
  end
